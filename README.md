...
<head>
    ...
    <title>DG Desarrollador Web</title>
</head>
...
<body>
    ...
    <section id="inicio">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>Diego Guardatti</span>, Desarrollador Web</h2>
                <p class="descripcion">Programador FullStack. Apasionado por la tecnologia. Preparado para desafios.</p>
    ...
    <section id="sobremi">
        ...
        <div class="sobremi">
            ...
            <h2>Hola, Soy <span>Diego Guardatti</span> </h2>
            <h3>Desarrollador Web</h3>
            <p>Soy un apasionado desarrollador web con un enfoque en la creación de experiencias digitales innovadoras y funcionales. Creador de diseño y desarrollo de sitios web a medida, me especializo en la utilización de las últimas tecnologías y mejores prácticas para construir soluciones robustas y eficientes. Mi habilidad para trabajar en equipo y comunicarme eficazmente con los clientes me permite transformar sus ideas en realidad digital de manera efectiva. Siempre estoy buscando nuevos desafíos para expandir mis habilidades y contribuir al éxito de los proyectos en los que participo.</p>    
            <a href="/Porfolio Diego Guardatti/Curriculum programador.pdf" download="CV.pdf">Descargar CV</a>
        </div>
    </section>
    ...
    <section id="servicios">
        ...
        <div class="fila">
            <div class="servicio">
                ...
                <p>Desarrollamos sitios funcionales e innovadores</p>
            </div>
            <div class="servicio">
                <span class="icono"><i class="fa-solid fa-file-code"></i></span>
                <h4>Programación PHP/Laravel</h4>
                <hr>
                <ul class="servicios-tag">
                    <li>Frontend</li>
                    <li>Backend</li>
                ...
                <p>Para que tu sitio tenga un Backend sólido</p>
            </div>
            <div class="servicio">
                ...
                <p>Posicionamiento en los principales motores de búsqueda</p>
            </div>
        </div>
        <div class="fila">
            <div class="servicio">
                ...
                <p>Nos ocupamos del hosting, el dominio y el mantenimiento del sitio</p>
            </div>
            <div class="servicio">
                ...
                <p>Trabajamos con profesionles para que el sitio sea moderno </p>
            </div>
            <div class="servicio">
                ...
                <p>Prestamos servicios de consultoría y asesoramiento en general</p>
            </div>
        </div>
    </section>
    ...
    <div class="contenedor-skills" id="skills">
        ...
        <div class="skill">
            <div class="info">
                <p> <span class="lista"> </span>Wordpress</p>
        ...
        <div class="skill">
            <div class="info">
                <p> <span class="lista"> </span>PHP/Laravel</p>
                <span class="porcentaje">85%</span>
            </div>
    ...
    <section id="portfolio">
        ...
        <div class="fila">
            <div class="proyecto">
                ...
                <img src="img/MuniLibertadorJujuy.jpg" alt="">
                <div class="info">
                    <h4>Registro de multas</h4>
                    <p>Proyecto en Laravel</p>
                </div>
            </div>
            <div class="proyecto">
                <div class="overlay"></div>
